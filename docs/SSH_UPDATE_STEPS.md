...
Инструкция для обновления приложения после коммитов (исправление ссылки личного кабинета и цикла редиректа). База данных в этом обновлении **не меняется** — таблица `ClientPortalAccess` уже должна быть создана ранее.
...
## Шаг 3. (Опционально) Проверить базу данных

Если личный кабинет клиента ещё не разворачивали или не уверены, что таблица есть:
