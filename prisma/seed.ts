...
async function main() {
  ...
  const allSections = ['sites', 'services', 'clients', 'contracts', 'invoices', 'closeout', 'storage', 'incomes', 'expenses', 'cost-items', 'employees', 'products', 'reports', 'legal-entities', 'roles', 'projects', 'niches', 'contacts', 'agents', 'payments'];
